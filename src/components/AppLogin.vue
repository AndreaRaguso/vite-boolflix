...
<template>
    ...
    <div class="navbar">
        ...
        <input class="ms-auto border-0 input-p" type="text" name="nameUSer" v-model="store.nameProfile" v-on:keyup.enter="store.loginOk = true" placeholder="Nome Profilo:" id="">
